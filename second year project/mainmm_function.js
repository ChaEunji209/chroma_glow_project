  ...
  const skinToneInfo = {
    ...
    dark: {
      ...
      text: `<p>
        <span class="hover-link">
          <div class="hover-card">
            <a href="https://en.wikipedia.org/wiki/Dark_skin" target="_blank">အသားအရေ မည်းညိုခြင်း (Dark skin tone) သည် မယ်လနင် (melanin) ကြွယ်ဝစွာ ပါဝင်သည့် အသားအရေကို ရည်ညွှန်းပြီး၊ ၎င်းသည် ခရမ်းလွန်ရောင်ခြည် (UV radiation) ကို သဘာဝအတိုင်း ကာကွယ်ပေးနိုင်ခြင်းအပြင်၊ ယဉ်ကျေးမှုနှင့် အလှအပဆိုင်ရာ လက္ခဏာရပ်မျိုးစုံကိုလည်း ပံ့ပိုးပေးပါသည်။</a>
          </div>
        </span></p>
